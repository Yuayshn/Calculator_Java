    ...
    public String calc(String input) throws Exception {
        ...
        if (rome) {
            if (result > 10 || result < 0) {
                throw new Exception("Результат римского числа должен быть в диапазоне между 0 и 10.");
            ...
            if (letter1 > 10 || letter1 < 0 || letter2 > 10 || letter2 < 0) {
                ...
                throw new Exception("Результат арабских чисел должен быть <= 0.");
            } else {
    ...
    public String getRomeNumber(int num) throws Exception {
        ...
        switch (num) {
            ...
            case 10:
                ...
                break;
            default:
                throw new Exception("Римское число >= 10 или <= 0.");
        }
        return romeNum;
    }
